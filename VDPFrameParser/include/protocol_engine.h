...
public:
     ...
     */
    carly::protocol::Response sendFrame(const carly::protocol::Frame& frame, 
     ...
     */
    void sendFrameAsync(const carly::protocol::Frame& frame,
                       carly::protocol::ResponseCallback on_response,
                       carly::protocol::ErrorCallback on_error);
...
private:
    ...
    struct PendingRequest {
        uint32_t request_id;
        carly::protocol::ResponseCallback response_callback;
        carly::protocol::ErrorCallback error_callback;
        std::chrono::steady_clock::time_point timeout_time;
        carly::protocol::Frame original_frame;
    };
    ...
    VdpFrame convertToVdpFrame(const carly::protocol::Frame& frame);
    carly::protocol::Frame convertFromVdpFrame(const VdpFrame& frame);
    carly::protocol::Response createResponse(carly::protocol::Status status, 
